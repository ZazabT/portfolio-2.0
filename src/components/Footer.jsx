...
export const Footer = () => {
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "tizazabayana@gmail.com", href: "mailto:tizazabayana@gmail.com" },
    { icon: <Phone size={16} />, text: "+251 913 173 163", href: "tel:+251913173163" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">TIZAZAB</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Full Stack Developer creating meaningful digital experiences.
              </p>
